...
res = DataFrame(CSV.File("Results pastry dough jmp.csv"))
...
res = DataFrame(CSV.File("Results pastry dough sas kr.csv"))
...
res = DataFrame(CSV.File("Results pastry dough sas sw.csv"))
